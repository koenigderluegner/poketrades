import{a as g}from"./chunk-MLQXPSX7.js";import"./chunk-BGHSUZ27.js";import"./chunk-MC2DVP3H.js";import{Bb as n,Cb as t,Db as o,Ta as s,Vb as e,Xb as m,db as l}from"./chunk-HDOEFQUA.js";import"./chunk-4CLCTAJ7.js";var h=`# Changelog
...
`;var b=(()=>{class i{constructor(){this.markdown=this._convertPokemonIconTokens(h)}_convertPokemonIconTokens(d){return d.replace(/::(?<pokemon>[\.\d\w-]+)(?<shiny>:shiny)?::/gm,(...a)=>{let{pokemon:r,shiny:c}=a[a.length-1];return`<i class="pokesprite pokemon ${r.toLowerCase()}${c?" shiny":""}"></i>`})}static{this.\u0275fac=function(a){return new(a||i)}}static{this.\u0275cmp=l({type:i,selectors:[["app-changelog"]],hostAttrs:[1,"container"],decls:23,vars:1,consts:[["routerLink","/help"],["href","https://www.reddit.com/message/compose/?to=KoenigDerLuegner"],["href","https://github.com/koenigderluegner/poketrades/issues"],[1,"markdown"]],template:function(a,r){a&1&&(n(0,"h1"),e(1,"Welcome!"),t(),n(2,"p"),e(3,'This is an early build of this website and has no "real" frontpage at the moment. '),o(4,"br"),e(5,"If you want to know how use this tool please visit the "),n(6,"a",0),e(7,"help section"),t(),e(8,". "),o(9,"br"),e(10,"If you want to give feedback or report bugs write me a "),n(11,"a",1),e(12,"message on reddit.com"),t(),e(13," or visit my "),n(14,"a",2),e(15,"GitHub issue section"),t(),e(16,". "),o(17,"br"),e(18,"If you're just browsing, then use the navigation at the top right."),t(),n(19,"p"),e(20,"That's all, have fun!"),t(),n(21,"markdown",3),e(22),t()),a&2&&(s(22),m(" ",r.markdown,`
`))},dependencies:[g],styles:[`.markdown h1:first-of-type{margin-top:0}.markdown ul{list-style-type:disc;margin-block-start:1em;margin-block-end:1em;padding-inline-start:40px}.markdown i.pokesprite.pokemon{margin:-34px -4px -10px}
`],encapsulation:2})}}return i})();export{b as ChangelogComponent};
